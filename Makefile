...
Core/Source/ads1120.c \
Core/Source/dac7311.c \
Core/Source/gw1nr.c \
Core/Source/main.c \
Core/Source/prime-s73p.c \
...
prog: $(BUILD_DIR)/$(TARGET).elf
	openocd -f interface/cmsis-dap.cfg -f target/gd32f30x.cfg -c "program build/$(TARGET).hex verify exit reset"
